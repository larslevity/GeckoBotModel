...
if __name__ == '__main__':
    ...
    f_ori = 100  # .0003     # factor on orientation objective
...
#    opt_ptrn = opt_ptrn[:4]
    ...
    prop_str = '{} | {} | {} | {} | {} | {} | {}'.format(
      method, len(obj_hist), round(opt_obj, 2), n_cycles, f_len, f_ori, f_ang)
...
#    Straight tries 19/07/03

# initial guess:
# [90, 0.1, -90, 90, 0.1]
#
# property string:
# COBYLA | 539 | -8.0 | 1 | 100.0 | 0.01 | 10
#
# optimal pattern:
# [[[0.26, -0.01, -180.15, 0.29, 0.00], [1, 0, 0, 1]],
#  [[-0.01, 0.26, 180.15, 0.00, 0.29], [0, 1, 1, 0]]]
...
#
# property string:
# COBYLA | 165 | -36.32 | 3 | 100.0 | 0.1 | 10
#
# optimal pattern:
# [[[48.90, 9.34, -170.54, 61.81, 9.87], [1, 0, 0, 1]],
#  [[9.34, 48.90, 170.54, 9.87, 61.81], [0, 1, 1, 0]]]
...
#
#property string:
# COBYLA | 141 | -6.85 | 1 | 100.0 | 1 | 10 
#
#optimal pattern:
# [[59.61, 11.3, -158.72, 71.64, 14.82], [1, 0, 0, 1],
#  [11.3, 59.61, 158.72, 14.82, 71.64], [0, 1, 1, 0]] 
