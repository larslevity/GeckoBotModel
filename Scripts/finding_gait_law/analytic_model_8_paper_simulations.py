...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 19 11:14:55 2019
...
if __name__ == "__main__":
    ...
    # %% Save all GAIT/STRESS as png
        ...
        #    fig.set_size_inches(18.5, 10.5)
            ...
            fig.savefig('../../Out/analytic_model8/gait_stress_{}.png'.format(modelstr),
                        transparent=True,
    ...
    #    fig.set_size_inches(18.5, 10.5)
        fig.set_size_inches(10.5, 8)
        fig.savefig('../../Out/analytic_model8/simerr='+str(round(Sim_err, 2))+'gait_deps_{}.png'.format(modelstr),
                    transparent=True,
                    dpi=300, bbox_inches='tight',)
# %%
        fig.clear()  # clean figure     
