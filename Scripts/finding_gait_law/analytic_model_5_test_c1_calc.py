...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 25 16:19:28 2020
...
#                gait.plot_gait()
        ...
        plt.yticks(Y_idx[0][::5], [round(x, 2) for x in C1[::5]])
    ...
    #    plt.axis('auto')
        ...
        fname = 'Out/analytic_model5/test_c1_calc/c1_analysis_q1_{}_weights_{}-{}-{}.tex'.format(x1, f_l, f_o, f_a)
