...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar  5 14:00:40 2021
...
gait_str = gait.get_tikz_repr(shift=20, dashed=0, linewidth='1mm', R=.8)
save.save_plt_as_tikz('Out/oscillator_robosoft.tex', gait_str,
