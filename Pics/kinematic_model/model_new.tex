...
\begin{tikzpicture}[
	part/.style={thick},
	anglearrow/.style={latex-latex, red},
	lettering/.style={red},
	anglearrow_phi/.style={latex-latex, red!70},
	lettering_phi/.style={red!80},
	helpline_phi/.style={gray},
	helpline/.style={gray!50},
	foot/.style={fill=gray},
	distarrow/.style={|<->|, blue!70},
	distlettering/.style={blue!80},
...
\pgfmathsetmacro{\ciii}{\eps+\gamh+\alpii-180}
...
%% COS
\path (-2,-2) coordinate(O)node[below]{$\{O\}$};
...
\draw[anglearrow_phi] (1)++(0:\angledist)arc(0:\eps-\gamh-90:\angledist);
...
%%% Vectors
\draw[vec](O)--(0)node[vechead,sloped, midway, above left]{$\bm{p}_0$};
\draw[vec](O)--(1)node[vechead,sloped, midway, above left]{$\bm{p}_1$};
\draw[vec](O)--(2)node[vechead,sloped, pos=.3, below]{$\bm{p}_2$};
\draw[vec](O)--(3)node[vechead,sloped, pos=.5, above]{$\bm{p}_3$};
\draw[vec](O)--(4)node[vechead,sloped, pos=.3, below]{$\bm{p}_4$};
\draw[vec](O)--(5)node[vechead,sloped, pos=.3, above]{$\bm{p}_5$};
}
