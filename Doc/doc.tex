...
\includegraphics[width=.95\textwidth]{pics/pathplanner_without_noise/example_curve/gait.png}


\begin{tabular}{ccc}
\includegraphics[width=.3\textwidth]{pics/pathplanner_without_noise/example_curve/dec0.png}
&
\includegraphics[width=.3\textwidth]{pics/pathplanner_without_noise/example_curve/dec2.png}
&
\includegraphics[width=.3\textwidth]{pics/pathplanner_without_noise/example_curve/dec3.png}
\\
\includegraphics[width=.3\textwidth]{pics/pathplanner_without_noise/example_curve/dec9.png}
&
\includegraphics[width=.3\textwidth]{pics/pathplanner_without_noise/example_curve/dec10.png}
&
\includegraphics[width=.3\textwidth]{pics/pathplanner_without_noise/example_curve/dec12.png}
\\
\includegraphics[width=.3\textwidth]{pics/pathplanner_without_noise/example_curve/dec16.png}
&
\includegraphics[width=.3\textwidth]{pics/pathplanner_without_noise/example_curve/dec18.png}
&
\\
\end{tabular}
