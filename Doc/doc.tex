...
\begin{dmath}
d = 
\left(xb_{x} \sin{\left (- n \left(- 0.835 x_{1} x_{2} - 0.005 x_{1} - 2.55 x_{2}^{2} - 10.85 x_{2}\right) \right )} + xb_{y} \cos{\left (- n \left(- 0.835 x_{1} x_{2} - 0.005 x_{1} - 2.55 x_{2}^{2} - 10.85 x_{2}\right) \right )} - \frac{\left(0.02 x_{1} - 0.47 x_{2}^{2} + 0.13 x_{2}\right) \sin{\left (\frac{n \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)}{2} \right )} \sin{\left (\frac{\left(n + 1\right) \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)}{2} \right )}}{\sin{\left (0.4175 x_{1} x_{2} + 0.0025 x_{1} + 1.275 x_{2}^{2} + 5.425 x_{2} \right )}} - \frac{\left(- 0.02 x_{1} x_{2} + 0.29 x_{2}^{2} - 0.07 x_{2}\right) \sin{\left (\frac{\left(n + 1\right) \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)}{2} \right )} \cos{\left (\frac{n \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)}{2} \right )}}{\sin{\left (0.4175 x_{1} x_{2} + 0.0025 x_{1} + 1.275 x_{2}^{2} + 5.425 x_{2} \right )}}\right)^{2} + \left(xb_{x} \cos{\left (- n \left(- 0.835 x_{1} x_{2} - 0.005 x_{1} - 2.55 x_{2}^{2} - 10.85 x_{2}\right) \right )} - xb_{y} \sin{\left (- n \left(- 0.835 x_{1} x_{2} - 0.005 x_{1} - 2.55 x_{2}^{2} - 10.85 x_{2}\right) \right )} - \frac{\left(0.02 x_{1} - 0.47 x_{2}^{2} + 0.13 x_{2}\right) \sin{\left (\frac{\left(n + 1\right) \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)}{2} \right )} \cos{\left (\frac{n \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)}{2} \right )}}{\sin{\left (0.4175 x_{1} x_{2} + 0.0025 x_{1} + 1.275 x_{2}^{2} + 5.425 x_{2} \right )}} + \frac{\left(- 0.02 x_{1} x_{2} + 0.29 x_{2}^{2} - 0.07 x_{2}\right) \sin{\left (\frac{n \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)}{2} \right )} \sin{\left (\frac{\left(n + 1\right) \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)}{2} \right )}}{\sin{\left (0.4175 x_{1} x_{2} + 0.0025 x_{1} + 1.275 x_{2}^{2} + 5.425 x_{2} \right )}}\right)^{2}
\end{dmath}
...
\subsubsection{Distance general Euler}
\begin{dmath}
d(x_1,x_2) = 
\frac{\left(\left(- \left(xb_{x} \left(e^{2 i n \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)} + 1\right) - i xb_{y} \left(- e^{2 i n \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)} + 1\right)\right) \left(- e^{i \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)} + 1\right) e^{\frac{i \left(2 n + 1\right) \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)}{2}} - \left(- i x_{2} \left(- e^{i n \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)} + 1\right) \left(0.02 x_{1} - 0.29 x_{2} + 0.07\right) - \left(e^{i n \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)} + 1\right) \left(0.02 x_{1} - 0.47 x_{2}^{2} + 0.13 x_{2}\right)\right) \left(- e^{i \left(n + 1\right) \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)} + 1\right) e^{i \left(n + \frac{1}{2}\right) \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)}\right)^{2} + \left(- \left(i xb_{x} \left(- e^{2 i n \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)} + 1\right) + xb_{y} \left(e^{2 i n \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)} + 1\right)\right) \left(- e^{i \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)} + 1\right) e^{\frac{i \left(2 n + 1\right) \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)}{2}} - \left(x_{2} \left(e^{i n \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)} + 1\right) \left(0.02 x_{1} - 0.29 x_{2} + 0.07\right) - i \left(- e^{i n \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)} + 1\right) \left(0.02 x_{1} - 0.47 x_{2}^{2} + 0.13 x_{2}\right)\right) \left(- e^{i \left(n + 1\right) \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)} + 1\right) e^{i \left(n + \frac{1}{2}\right) \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)}\right)^{2}\right) e^{- i \left(4 n + 1\right) \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)}}{4 \left(- e^{i \left(0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2}\right)} + 1\right)^{2}}
\end{dmath}
...
\begin{dmath}
d_2(x_1, x_2) =
\left(xb_{x} \sin{\left (1.67 x_{1} x_{2} + 0.01 x_{1} + 5.1 x_{2}^{2} + 21.7 x_{2} \right )} + xb_{y} \cos{\left (1.67 x_{1} x_{2} + 0.01 x_{1} + 5.1 x_{2}^{2} + 21.7 x_{2} \right )} - \frac{\left(0.02 x_{1} - 0.47 x_{2}^{2} + 0.13 x_{2}\right) \sin{\left (0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2} \right )} \sin{\left (1.2525 x_{1} x_{2} + 0.0075 x_{1} + 3.825 x_{2}^{2} + 16.275 x_{2} \right )}}{\sin{\left (0.4175 x_{1} x_{2} + 0.0025 x_{1} + 1.275 x_{2}^{2} + 5.425 x_{2} \right )}} - \frac{\left(- 0.02 x_{1} x_{2} + 0.29 x_{2}^{2} - 0.07 x_{2}\right) \sin{\left (1.2525 x_{1} x_{2} + 0.0075 x_{1} + 3.825 x_{2}^{2} + 16.275 x_{2} \right )} \cos{\left (0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2} \right )}}{\sin{\left (0.4175 x_{1} x_{2} + 0.0025 x_{1} + 1.275 x_{2}^{2} + 5.425 x_{2} \right )}}\right)^{2} + \left(xb_{x} \cos{\left (1.67 x_{1} x_{2} + 0.01 x_{1} + 5.1 x_{2}^{2} + 21.7 x_{2} \right )} - xb_{y} \sin{\left (1.67 x_{1} x_{2} + 0.01 x_{1} + 5.1 x_{2}^{2} + 21.7 x_{2} \right )} - \frac{\left(0.02 x_{1} - 0.47 x_{2}^{2} + 0.13 x_{2}\right) \sin{\left (1.2525 x_{1} x_{2} + 0.0075 x_{1} + 3.825 x_{2}^{2} + 16.275 x_{2} \right )} \cos{\left (0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2} \right )}}{\sin{\left (0.4175 x_{1} x_{2} + 0.0025 x_{1} + 1.275 x_{2}^{2} + 5.425 x_{2} \right )}} + \frac{\left(- 0.02 x_{1} x_{2} + 0.29 x_{2}^{2} - 0.07 x_{2}\right) \sin{\left (0.835 x_{1} x_{2} + 0.005 x_{1} + 2.55 x_{2}^{2} + 10.85 x_{2} \right )} \sin{\left (1.2525 x_{1} x_{2} + 0.0075 x_{1} + 3.825 x_{2}^{2} + 16.275 x_{2} \right )}}{\sin{\left (0.4175 x_{1} x_{2} + 0.0025 x_{1} + 1.275 x_{2}^{2} + 5.425 x_{2} \right )}}\right)^{2}
\end{dmath}
