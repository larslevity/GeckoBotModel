...
# %% Save all the figs as png
    ...
    fig.savefig('Out/analytic_model4/gait.png', transparent=False,
                dpi=300)

    plt.figure('GeckoBotGaitAlphaHistory')
    fig = plt.gcf()
    fig.set_size_inches(18.5, 10.5)
    fig.savefig('Out/analytic_model4/GeckoBotGaitAlphaHistory.png', dpi=300)

    plt.figure('GeckoBotGaitPhiHistory')
    fig = plt.gcf()
    fig.set_size_inches(18.5, 10.5)
    fig.savefig('Out/analytic_model4/GeckoBotGaitPhiHistory.png', dpi=300)

    plt.figure('GeckoBotGaitStress')
    fig = plt.gcf()
    fig.set_size_inches(18.5, 10.5)
    fig.savefig('Out/analytic_model4/GeckoBotGaitStress.png', dpi=300)
    ...
    fig = plt.gcf()
    fig.set_size_inches(18.5, 10.5)
    fig.savefig('Out/analytic_model4/FitDeps.png', dpi=300)
...
#    tit = '$\delta x(x_1, x_2)= \\begin{array}{c} %s \\\ %s \\end{array}$' % (dx, dy)
    ...
    fig = plt.gcf()
    fig.set_size_inches(18.5, 10.5)
    fig.savefig('Out/analytic_model4/FitDXDY.png', dpi=300)
